...
ifeq ($(findstring linaro, $(CONFIG_GCC_VERSION)),linaro)
    ...
    ifeq ($(CONFIG_GCC_VERSION),"4.9-linaro")
      ...
      PKG_MD5SUM:=e978776eb7b1b0101015c5ffb00d8292
      PKG_COMP:=xz
    endif
    ifneq ($(LINARO_RELEASE),)
      PKG_SOURCE_URL:=http://releases.linaro.org/archive/$(LINARO_RELEASE)/components/toolchain/gcc-linaro/$(PKG_VERSION_MAJOR)
    else
...
ifeq ($(CONFIG_CPU_TYPE),"4281")
  GCC_CONFIGURE +=  --with-arch=4281
endif
