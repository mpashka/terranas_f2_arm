...
function ssid.write(self, section, value)
	...
	local essid = (cmssid_en and (is_guest ~= "enable")) and cmssid or value
	wnet:set("ssid", essid)
	nw:commit("wireless")
	Value.write(self, section, essid)
end
...
if hwtype == "mac80211" or hwtype == "prism2" then
	...
	if hostapd and supplicant then
		...
		encr:value("psk2", "WPA2-PSK", {mode="ap"}, {mode="sta"}, {mode="ap-wds"}, {mode="sta-wds"}, {mode="adhoc"}, {mode="rtkmesh"})
