...
int main (int argc, const char **argv)
{
    ...
    channelID[0] = gst_dec_add_channel();
    channelID[1] = gst_dec_add_channel();
    channelID[2] = gst_dec_add_channel();
    channelID[3] = gst_dec_add_channel();
    channelID[4] = gst_dec_add_channel();
    channelID[5] = gst_dec_add_channel();
    channelID[6] = gst_dec_add_channel();
    channelID[7] = gst_dec_add_channel();
    channelID[8] = gst_dec_add_channel();
    /* Set the URI to play */
    ...
    wndlID[0] = gst_disp_create(0, 0, 640, 360);
    wndlID[1] = gst_disp_create(0, 360, 640, 360);
    wndlID[2] = gst_disp_create(0, 720, 640, 360);
    wndlID[3] = gst_disp_create(640, 0, 640, 360);
    wndlID[4] = gst_disp_create(640, 360, 640, 360);
    wndlID[5] = gst_disp_create(640, 720, 640, 360);
    wndlID[6] = gst_disp_create(1280, 0, 640, 360);
    wndlID[7] = gst_disp_create(1280, 360, 640, 360);
    wndlID[8] = gst_disp_create(1280, 720, 640, 360);
