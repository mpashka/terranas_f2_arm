...
SQUASHFSOPT += -noappend -root-owned
SQUASHFSCOMP := gzip
ifneq ($(CONFIG_TARGET_rtl8117),y)
...
define Image/mkfs/squashfs
	$(STAGING_DIR_HOST)/bin/mksquashfs4 $(TARGET_DIR) $(KDIR)/root.squashfs -comp $(SQUASHFSCOMP) $(SQUASHFSOPT) -processors $(if $(CONFIG_PKG_BUILD_JOBS),$(CONFIG_PKG_BUILD_JOBS),1)
endef
