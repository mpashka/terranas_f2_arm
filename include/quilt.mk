...
ifeq ($(LINARO_KERNEL),y)
	$(if $(GENERIC_ANDROID_PATCH_DIR),$(call PatchDir,$(PKG_BUILD_DIR),$(GENERIC_ANDROID_PATCH_DIR),linaro/))
endif
endef
endif
...
define Quilt/Refresh/Kernel
	@[ -z "$$(grep -v '^generic/' $(PKG_BUILD_DIR)/patches/series | grep -v '^platform/' | grep -v '^linaro/' )"] || { \
		echo "All kernel patches must start with either generic/ or platform/ or linaro/ "; \
		false; \
	}
	$(call Quilt/RefreshDir,$(PKG_BUILD_DIR),$(GENERIC_PATCH_DIR),generic/)
	$(call Quilt/RefreshDir,$(PKG_BUILD_DIR),$(PATCH_DIR),platform/)
	$(if $(PATCH_SUBTARGET_DIR),$(call Quilt/RefreshDir,$(PKG_BUILD_DIR),$(PATCH_SUBTARGET_DIR),subtarget/))
	$(if $(GENERIC_ANDROID_PATCH_DIR),$(call Quilt/RefreshDir,$(PKG_BUILD_DIR),$(GENERIC_ANDROID_PATCH_DIR),linaro/))
endef
