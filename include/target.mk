...
GENERIC_ANDROID_DIR := $(TOPDIR)/target/linux/linaro
GENERIC_PLATFORM_DIR := $(TOPDIR)/target/linux/generic
GENERIC_ANDROID_PATCH_DIR := $(GENERIC_ANDROID_DIR)/patches$(if $(wildcard $(GENERIC_ANDROID_DIR)/patches-$(KERNEL_PATCHVER)),-$(KERNEL_PATCHVER))
