...
define DownloadMethod/git
	$(call wrap_mirror, \
		...
		rm -rf $(SUBDIR) && \
		[ \! -d $(SUBDIR) ] && \
		git clone $(if $(BRANCH),--branch $(BRANCH)) $(GITOPT) $(URL) $(SUBDIR) && \
...
define Download/rtk
  ifeq ($(PROTO),git)
  URL:=$(subst @DHCGERRIT,ssh://$(if $(USERNAME),$(USERNAME)@)dhcgerrit.realtek.com.tw:20002,$(subst @SD10GERRIT,ssh://$(if $(USERNAME),$(USERNAME)@)cn1sd10gerrit1.realtek.com.tw:20009, \
	  $(subst @SD10IIGERRIT,ssh://$(if $(USERNAME),$(USERNAME)@)cn1sd10gerrit1.realtek.com.tw:20013,$(URL))))
  endif
endef
...
define Download
  ...
  $(eval $(Download/$(1)))
  $(eval $(Download/rtk))
  $(if $(findstring HEAD,$(VERSION)),$(call Download/Head))
