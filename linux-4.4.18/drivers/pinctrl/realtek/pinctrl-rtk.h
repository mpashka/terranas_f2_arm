#ifndef __PINCTRL_RTK_H
#define __PINCTRL_RTK_H
...
static const struct rtk_pin_regmap pin_regmap[] = {
	...
	{.pmux_regoff=0x36c, 	.pmux_regbit=18, .pmux_regbitmsk=0x3,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_CRT_BASE + 60,  	"hi_loc")
	{.pmux_regoff=0x36c, 	.pmux_regbit=20, .pmux_regbitmsk=0x3,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_CRT_BASE + 61,  	"ejtag_scpu_loc")
	{.pmux_regoff=0x374, 	.pmux_regbit=0, .pmux_regbitmsk=0x1,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_CRT_BASE + 62,  	"sf_en")
	{.pmux_regoff=0x374, 	.pmux_regbit=2, .pmux_regbitmsk=0x3,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_CRT_BASE + 63,  	"ao_loc")
	////////////////////////////iso_muxpad0////////////////////////////
	...
	{.pmux_regoff=0x314, 	.pmux_regbit=24, .pmux_regbitmsk=0x1,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_ISO_BASE + 21,  	"pwm_23_open_drain_switch")
	{.pmux_regoff=0x314, 	.pmux_regbit=25, .pmux_regbitmsk=0x1,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_ISO_BASE + 22,  	"pwm_01_open_drain_switch")
	{.pmux_regoff=0x314, 	.pmux_regbit=26, .pmux_regbitmsk=0x3,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_ISO_BASE + 23,  	"ur1_loc")
	{.pmux_regoff=0x314, 	.pmux_regbit=28, .pmux_regbitmsk=0x3,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_ISO_BASE + 24,  	"ejtag_avcpu_loc")
	{.pmux_regoff=0x314, 	.pmux_regbit=30, .pmux_regbitmsk=0x3,	.pcof_regoff=0x0, .pcof_regbit=0, .pcof_cur_strgh = 0}, //(P_ISO_BASE + 25,  	"ai_loc")
};
#endif
...
#elif CONFIG_ARCH_RTD119X
static const struct RTK_desc_pin rtk_pins[] = {
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_0,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "uart1_loc_misc"),
		RTK_FUNCTION(0x3, "hif_loc_misc"),
		RTK_FUNCTION(0x4, "gspi")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_1,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "uart1_loc_misc"),
		RTK_FUNCTION(0x3, "hif_loc_misc"),
		RTK_FUNCTION(0x4, "gspi")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_2,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "uart1_loc_misc"),
		RTK_FUNCTION(0x3, "hif_loc_misc"),
		RTK_FUNCTION(0x4, "gspi")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_3,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "uart1_loc_misc"),
		RTK_FUNCTION(0x3, "hif_loc_misc"),
		RTK_FUNCTION(0x4, "gspi")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_4,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "scpu_ejtag_loc_misc"),
		RTK_FUNCTION(0x3, "ao_loc_misc")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_5,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "scpu_ejtag_loc_misc"),
		RTK_FUNCTION(0x3, "ao_loc_misc")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_6,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "scpu_ejtag_loc_misc"),
		RTK_FUNCTION(0x3, "ao_loc_misc")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_7,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "scpu_ejtag_loc_misc"),
		RTK_FUNCTION(0x3, "ao_loc_misc")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_gpio_8,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "scpu_ejtag_loc_misc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_2,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_3,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_4,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "hif_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_5,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_6,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_dd_7,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_nf")),
	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_rdy,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_rd_n,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_wr_n,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "hif_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_ale,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "hif_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_cle,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand"),
		RTK_FUNCTION(0x2, "emmc"),
		RTK_FUNCTION(0x3, "hif_loc_nf")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_ce_n_0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_nf_ce_n_1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "nand")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_data_0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc"),
		RTK_FUNCTION(0x3, "scpu_ejtag_loc_cr")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_data_1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_data_2,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_data_3,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc"),
		RTK_FUNCTION(0x3, "scpu_ejtag_loc_cr")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_clk,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc"),
		RTK_FUNCTION(0x3, "scpu_ejtag_loc_cr")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_cmd,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc"),
		RTK_FUNCTION(0x3, "scpu_ejtag_loc_cr")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_wp,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc"),
		RTK_FUNCTION(0x3, "scpu_ejtag_loc_cr")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_mmc_cd,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "mmc")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_sdio_clk,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sdio")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_sdio_data_0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sdio")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_sdio_data_1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sdio")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_sdio_data_2,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sdio")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_sdio_data_3,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sdio")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_sdio_cmd,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sdio")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_i2c_scl_5,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c5"),
		RTK_FUNCTION(0x3, "nand")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_i2c_sda_5,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c5"),
		RTK_FUNCTION(0x3, "nand")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp1_data,
		RTK_FUNCTION(0x0, "tp1"),
		RTK_FUNCTION(0x1, "tp0"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "i2c3")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp1_clk,
		RTK_FUNCTION(0x0, "tp1"),
		RTK_FUNCTION(0x1, "tp0"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "i2c2")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp1_valid,
		RTK_FUNCTION(0x0, "tp1"),
		RTK_FUNCTION(0x1, "tp0"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "i2c3")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp1_sync,
		RTK_FUNCTION(0x0, "tp1"),
		RTK_FUNCTION(0x1, "tp0"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "i2c2")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp0_data,
		RTK_FUNCTION(0x0, "tp0"),
		RTK_FUNCTION(0x1, "tp1"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "ao_loc_tp")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp0_clk,
		RTK_FUNCTION(0x0, "tp0"),
		RTK_FUNCTION(0x1, "tp1"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "ao_loc_tp")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp0_valid,
		RTK_FUNCTION(0x0, "tp0"),
		RTK_FUNCTION(0x1, "tp1"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "ao_loc_tp")),
 	RTK_PIN(RTK_PINCTRL_PIN_PCRT_tp0_sync,
		RTK_FUNCTION(0x0, "tp0"),
		RTK_FUNCTION(0x1, "tp1"),
		RTK_FUNCTION(0x2, "gpio"),
		RTK_FUNCTION(0x3, "ao_loc_tp")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_usb_id,
		RTK_FUNCTION(0x1, "gpio"),
		RTK_FUNCTION(0x2, "cpu_loop")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_hdmi_hpd,
		RTK_FUNCTION(0x1, "gpio")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_spdif,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "spdif")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_i2c_scl_1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c1")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_i2c_sda_1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c1")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_i2c_scl_4,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c4")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_i2c_sda_4,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c4")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_sensor_cko_0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sensor")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_sensor_cko_1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "sensor"),
		RTK_FUNCTION(0x3, "usb")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_sensor_rst,
		RTK_FUNCTION(0x0, "gpio")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_sensor_stb_0,
		RTK_FUNCTION(0x0, "gpio")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_sensor_stb_1,
		RTK_FUNCTION(0x0, "gpio")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_hi_loc,
		RTK_FUNCTION(0x1, "hif_loc_misc"),
		RTK_FUNCTION(0x2, "hif_loc_nf")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_ejtag_scpu_loc,
		RTK_FUNCTION(0x1, "scpu_ejtag_loc_misc"),
		RTK_FUNCTION(0x2, "scpu_ejtag_loc_cr")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_sf_en,
		RTK_FUNCTION(0x0, "uart1_loc_misc"),
		RTK_FUNCTION(0x0, "hif_loc_misc"),
		RTK_FUNCTION(0x0, "gspi"),
		RTK_FUNCTION(0x1, "spi")),
	 RTK_PIN(RTK_PINCTRL_PIN_PCRT_ao_loc,
		RTK_FUNCTION(0x1, "ao_loc_tp"),
		RTK_FUNCTION(0x2, "ao_loc_misc")),
//////////iso pinmux////////////////
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_iso_gpio0,
		RTK_FUNCTION(0x0, "gpio")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_iso_gpio1,
		RTK_FUNCTION(0x0, "gpio")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_usb0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "standby_dbg"),
		RTK_FUNCTION(0x2, "ai_loc_iso_usb"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_iso")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_usb1,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "standby_dbg"),
		RTK_FUNCTION(0x2, "ai_loc_iso_usb"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_iso")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_vfd_cs_n,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "vfd"),
		RTK_FUNCTION(0x2, "ai_loc_iso_usb"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_iso")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_vfd_clk,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "vfd"),
		RTK_FUNCTION(0x2, "ai_loc_iso_usb"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_iso")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_vfd_d,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "vfd"),
		RTK_FUNCTION(0x2, "i2c2"),
		RTK_FUNCTION(0x3, "avcpu_ejtag_loc_iso")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ir_rx,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "irrx"),
		RTK_FUNCTION(0x2, "standby_dbg")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ir_tx,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "irtx"),
		RTK_FUNCTION(0x2, "i2c3")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ur0_rx,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "uart0"),
		RTK_FUNCTION(0x2, "pwm")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ur0_tx,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "uart0"),
		RTK_FUNCTION(0x2, "pwm")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ur1_rx,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "uart1_loc_iso"),
		RTK_FUNCTION(0x2, "ai_loc_iso_ur"),
		RTK_FUNCTION(0x3, "pwm")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ur1_tx,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "uart1_loc_iso"),
		RTK_FUNCTION(0x2, "ai_loc_iso_ur"),
		RTK_FUNCTION(0x3, "pwm")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ur1_cts_n,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "uart1_loc_iso"),
		RTK_FUNCTION(0x2, "ai_loc_iso_ur")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ur1_rts_n,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "uart1_loc_iso"),
		RTK_FUNCTION(0x2, "ai_loc_iso_ur")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_i2c_scl_0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c0")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_i2c_sda_0,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c0")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_etn_led_link,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "etn_led"),
		RTK_FUNCTION(0x2, "pwm")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_etn_led_rxtx,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "etn_led"),
		RTK_FUNCTION(0x2, "pwm")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_i2c_scl_6,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c6")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_i2c_sda_6,
		RTK_FUNCTION(0x0, "gpio"),
		RTK_FUNCTION(0x1, "i2c6")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ur1_loc,
		RTK_FUNCTION(0x1, "uart1_loc_iso"),
		RTK_FUNCTION(0x2, "uart1_loc_misc")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ejtag_avcpu_loc,
		RTK_FUNCTION(0x1, "avcpu_ejtag_loc_iso"),
		RTK_FUNCTION(0x2, "avcpu_ejtag_loc_nf")),
	 RTK_PIN(RTK_PINCTRL_PIN_PISO_ai_loc,
		RTK_FUNCTION(0x1, "ai_loc_iso_ur"),
		RTK_FUNCTION(0x2, "ai_loc_iso_usb")),
};
#endif

#endif /* __PINCTRL_RTK_H */
