...
#define write_imem_base(val)	__write_32bit_c3_register($0, val)
#define write_imem_top(val)	__write_32bit_c3_register($1, val)
...
#define CCTL_IMEM0LDSTLON	0x00000004
#define CCTL_IMEM0LDSTLOFF	0x00000008
