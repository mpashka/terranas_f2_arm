...
/* br_forward.c */
extern void br_deliver(const struct net_bridge_port *to, struct sk_buff *skb);
extern int br_dev_queue_push_xmit(struct net *net, struct sock *sk, struct sk_buff *skb);
#if defined(CONFIG_RTL_IGMP_SNOOPING)
...
#endif /* CONFIG_RTL_IGMP_SNOOPING */
extern int br_forward_finish(struct net *net, struct sock *sk, struct sk_buff *skb);
extern void br_flood_deliver(struct net_bridge *br, struct sk_buff *skb, bool unicast);
#if defined(CONFIG_RTL_IGMP_SNOOPING)
