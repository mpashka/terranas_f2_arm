/*
 * Configuration settings for the Realtek 1036 qa board.
 *
 * Won't include this file.
 * Just type "make <board_name>_config" and will be included in source tree.
 */

#ifndef __CONFIG_RTK_RTD1036_QA_SPI_H
#define __CONFIG_RTK_RTD1036_QA_SPI_H
...
/*
 * The followings were RTD1036 qa board specific configuration settings.
 */

/* Board config name */
#define CONFIG_BOARD_QA_RTD1036
...
//#define CONFIG_NAND_ON_THE_FLY_TEST_KEY
    ...
    #define CONFIG_FLASH_WRITER_SETTING                 "1036_common"
    #define CONFIG_CHIP_ID                              "rtd1036"
    ...
    #define CONFIG_DTB_BASE                             0x000D0000
    #define CONFIG_DTB_SIZE                             0x00010000
#else
    #define CONFIG_BOOTCODE2_MAX_SIZE					0x00060000			// up to 384KB
    #define CONFIG_DTB_BASE                             0xFFFFFFFF
    #define CONFIG_DTB_SIZE                             0x00000000
#endif
...
#endif /* __CONFIG_RTK_RTD1036_QA_SPI_H */
