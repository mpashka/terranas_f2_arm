...
define KernelPackage/fs-nfsroot
  SUBMENU:=$(FS_MENU)
  TITLE:=NFSROOT filesystem support
  KCONFIG:= \
	  CONFIG_DEVTMPFS=y \
	  CONFIG_CGROUPS=y \
...
define KernelPackage/fs-nfsroot/description
 Kernel module for NFS ROOT support
endef

$(eval $(call KernelPackage,fs-nfsroot))
