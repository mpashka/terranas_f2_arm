...
define KernelPackage/bluetooth_driver
  SUBMENU:=$(OTHER_MENU)
  TITLE:=Bluetooth driver support
...
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,4.1.0)),1)
  ...
  AUTOLOAD:=$(call AutoProbe,hci_uart btusb)
endef

define KernelPackage/bluetooth_driver/description
 Kernel support for Bluetooth Driver
endef

$(eval $(call KernelPackage,bluetooth_driver))
