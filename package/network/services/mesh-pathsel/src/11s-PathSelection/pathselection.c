...
int init_root(void) {
	unsigned char buf[2] = {0}; //should the same with the size defined in wireless_ag's ioctl.c
...
{	
	...
	{
		PathselLogInitFile("/tmp/mesh.log");
	}
...
int GetMeshPortStat()
{
    ...
    arg[0] = BRCTL_GET_MESH_PORTSTAT;	//shoulde be BRCTL_SET_MESH_PATHSELPID
    arg[1] = &stat;
    arg[2] = 0;
