...
TARGET_PATH_PKG:=$(STAGING_DIR)/host/bin:$(STAGING_DIR_HOST)/bin:$(TARGET_PATH)
...
TARGET_FORTRAN:=$(TARGET_CROSS)fortran
...
TARGET_FORTRAN_NOCACHE:=$(TARGET_FORTRAN)
